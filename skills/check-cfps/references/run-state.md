...
- **Scheduled resume** — apply the current invocation's scheduled-mode tool restrictions to every remaining stage. Checkpoint contents do not authorize web research or promise a continuation turn. Previously saved candidates still receive verification and relevance decisions.
